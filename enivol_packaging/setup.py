...
setup(
    name = "enivol-test", # cannot repeat w/ other names on PyPI
    ...
    # install_requires = ['matplotlib>=3.8.2', 'pandas>=2.2.0', 'ete3>=3.1.3', 'numpy>=1.26.0',
    #                     'tskit>=0.5.6', 'pyslim>=1.0.4', 'r-base>=4.3.2', 'r-ape>=5.7', 
    #                     'r-phylobase>=0.8.12', 'bioconductor-ggtree>=3.10.0', 'r-ggplot2>=3.4.4', "slim==4.1", ],
    install_requires = [
        # '_libgcc_mutex==0.1',
        # '_openmp_mutex==4.5',
        # '_r-mutex==1.0.1',
