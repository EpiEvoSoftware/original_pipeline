...
# Postprocessing_options Configurations
    ...
    def render_do_postprocess(self):
        ...
        self.do_postprocess_label = ttk.Label(self.control_frame, text="do_postprocess:").pack()
        ...
        self.update_do_postprocess_button = tk.Button(self.control_frame, text="Update Method", command=update).pack()
    ...
    def render_drug_resistance_heatmap(self):
        ...
        self.drug_resistance_heatmap_label = ttk.Label(self.control_frame, text="drug_resistance_heatmap:").pack()
        ...
        self.update_drug_resistance_heatmap_button = tk.Button(self.control_frame, text="Update Method", command=update).pack()
