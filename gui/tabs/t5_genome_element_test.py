    ...
    def load_page(self):
        ...
        if self.use_genetic_model:
            if ui_selected:
                ...
                set_to_rerender.add(self.user_input_group_control)
                set_to_rerender.add(self.num_traits_group_control)

                set_to_derender = GroupControls()
                set_to_derender.add(self.random_generate_group_control)
                ...
                set_to_derender = GroupControls()
                set_to_derender.add(self.user_input_group_control)
