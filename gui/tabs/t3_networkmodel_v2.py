...
class NetworkModel:
    def __init__(
        ...
        # self.graph = NetworkModelGraph(self.bottom_frame, tab_parent, config_path)
        # self.sidebar = NetworkModelConfigurations(self.top_frame, tab_parent, config_path, tab_index)
        ...
        # Formerly NetworkModelConfigurations
        self.config_path = config_path
        self.control_frame = ttk.Frame(self.top_frame, width=300)
        ...
        #Formerly NetworkModelGraph
        self.tab_parent = tab_parent
        self.config_path = config_path
        wk_dir = load_config_as_dict(self.config_path)["BasicRunConfiguration"]["cwdir"]
    ...
    def render_host_size(self):
        ...
        host_size_entry.insert(0, str(load_config_as_dict(self.config_path)["NetworkModelParameters"]["host_size"]))
    ...
    def render_use_network_model(self):
        ...
        use_network_model_var = tk.BooleanVar(value=load_config_as_dict(self.config_path)["NetworkModelParameters"]["use_network_model"])
    ...
    def render_method(self):
        ...
        network_method_var = tk.StringVar(value=load_config_as_dict(self.config_path)["NetworkModelParameters"]["method"])
    ...
    def render_select_file(self):
        ...
        file = load_config_as_dict(self.config_path)["NetworkModelParameters"]["user_input"]["path_network"]
    ...
    def render_network_model(self):
        def update(event):
            config = load_config_as_dict(self.config_path)
            config["NetworkModelParameters"]["randomly_generate"]["network_model"] = network_model_var.get()
            with open(self.config_path, "w") as file:
                json.dump(config, file, indent=4)
        ...
        network_model_var = tk.StringVar(value=load_config_as_dict(self.config_path)["NetworkModelParameters"]["randomly_generate"]["network_model"])
    ...
    def render_ER(self):
        ...
        p_ER_entry.insert(0, str(load_config_as_dict(self.config_path)["NetworkModelParameters"]["randomly_generate"]["ER"]["p_ER"]))
    ...
    def render_RP(self):
        ...
        rp_size_entry.insert(0, str(load_config_as_dict(self.config_path)["NetworkModelParameters"]["randomly_generate"]["RP"]["rp_size"]))
        ...
        p_within_entry.insert(0, str(load_config_as_dict(self.config_path)["NetworkModelParameters"]["randomly_generate"]["RP"]["p_within"]))
        ...
        p_between_entry.insert(0, str(load_config_as_dict(self.config_path)["NetworkModelParameters"]["randomly_generate"]["RP"]["p_between"]))
    ...
    def render_BA(self):
        ...
        ba_m_entry.insert(0, str(load_config_as_dict(self.config_path)["NetworkModelParameters"]["randomly_generate"]["BA"]["ba_m"]))
    ...
    def render_run_network_generation(self):
        def run_network_generate():
            ...
            try:
                ...
                network_model = config["NetworkModelParameters"]["randomly_generate"]["network_model"]
    ...
    def update_config(self):
        ...
        try:
            ...
            config["NetworkModelParameters"]["host_size"] = host_size
        except ValueError:
        ...
        match config["NetworkModelParameters"]["randomly_generate"]["network_model"]:
            case "ER":
                try:
                    p_ER = float(self.update_config_entries["p_ER"].get())
                    assert(0 < p_ER <= 1)
                    config["NetworkModelParameters"]["randomly_generate"]["ER"]["p_ER"] = p_ER
            ...
            case "RP":
                try:
                    ...
                    config["NetworkModelParameters"]["randomly_generate"]["RP"]["rp_size"] = rp_size
                except (AssertionError, ValueError):
                ...
                try:
                    ...
                    assert(len(rp_size) == 2)
                    config["NetworkModelParameters"]["randomly_generate"]["RP"]["p_within"] = p_within
                except (AssertionError, ValueError):
                ...
                try:
                    ...
                    config["NetworkModelParameters"]["randomly_generate"]["RP"]["p_between"] = p_between
                except ValueError:
            ...
            case "BA":
                try:
                    ...
                    config["NetworkModelParameters"]["randomly_generate"]["BA"]["ba_m"] = ba_m
                except ValueError:
    ...
    def create_graph_frame(self):
        self.graph_frame = ttk.Frame(self.bottom_frame)
