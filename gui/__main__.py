...
def launch_gui(config_path, hide = False):
    ...
    if hide:
        ...
        network_app = SeedsConfiguration(tab4, tab_parent, config_path, "Seeds Configuration", 4, hide = True)
        ...
        network_app = SeedsConfiguration(tab4, tab_parent, config_path, "Seeds Configuration", 4)
